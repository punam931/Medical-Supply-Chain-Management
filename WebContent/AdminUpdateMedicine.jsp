   ...
   %>
	<div class="hero_area">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<div
							...
							<div class="login_btn-contanier ml-0 ml-lg-5">
								<ul class="navbar-nav  ">
									<jsp:include page="manufacturemenu.jsp"></jsp:include>
									</ul>
							</div>
						</div>
					</div>
		...
		<section class=" slider_section position-relative">
							...
							<div class="row">
								...
								<div class="col-md-8">
									<div class="detail-box">
										<h1>
											Welcome To Manufacture  <br> <span> Online Medicine </span>
			...
			<form action="AddAdmin" method="post" class="form-block form-bold form-mb-20 form-h-35 form-brdr-b-grey pr-50 pr-sm-0">
			            	<table align="center" border="1"  cellpadding="5" cellspacing="5">
					 <tr>
						<td><b>Supplier Name</b></td>
						<td><input type="text" name="MedicineName"  required="required" value="<%=MedicineName %>" readonly="readonly"/></td>
						<td><b>Company Name</b></td>
						<td><input type="text" name="companyname"  readonly="readonly" value="<%=CompanyName %>" readonly="readonly" /></td>
					</tr>
					<tr>
						<td><b>Raw Materials </b></td>
						<td><input type="text" name="Descriptionname"  value="<%=DescriptionName %>" readonly="readonly"/></td>
						<td><b>MFG. Date</b></td>
					...
					<tr>
						<td><b>QTY</b></td>
						<td><input type="text" name="qty"  value="<%=oldqty %>" readonly="readonly" /></td>
						<td><b>Enter QTY</b></td>
						<td><input type="text" name="newqty"  placeholder="Enter Qty" required="required" pattern="^[1-9]\d*(\.\d+)?$" /></td>
						
						
					</tr>
					<tr>
						<td><input type="hidden" name="mid" readonly="readonly" value="<%=id %>"  /></td>
