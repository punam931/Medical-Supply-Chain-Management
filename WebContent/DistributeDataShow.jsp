							...
							<div class="row">
								...
								<div class="col-md-8">
									<div class="detail-box">
										...
										<table align="center" style="width: 100%;" class="displays"
								border="1">
								<tr>

									<td><b>Company ID</b></td>
									<td><b>Dist_Email_ID</b></td>
									<td><b>Medicine Name</b></td>
									<td><b>Qty</b></td>
									<td><b>Dist Mob_No</b></td>
									<td colspan="2" align="center"><b>Action</b></td>
								</tr>
								<%
									String emailid = (String) session.getAttribute("Muserid");
									try {
										int i = 1;
										String query = "select * from medicine_info_order where Status_Info='0' and CompanyName='"
												+ emailid + "'";
								...
								<tr>
									...
									<td><a 
										href="Accept?id=<%=rs.getString(7)%>,<%=rs.getString(1)%>"
										style="background: yellow; color: black;">Accept</a></td>
										<td><a
										href="Reject?id=<%=rs.getString(7)%>,<%=rs.getString(1)%>"
										style="background: yellow; color: black;">Reject</a></td>
								</tr>
								<%
									}
											i++;
