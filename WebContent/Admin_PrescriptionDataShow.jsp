						...
						<div class="container">
							<div class="row">
								...
								<%
								 try{
									  int i=1;
									  String query="select * from tbl_doctor_prescription where Status='Sending'";
								...
								<tr>
									...
									<td><a
										href="updatemedicine?id=<%=rs.getString(1)%>&emailid=<%=rs.getString(2)%>"
										style="background: yellow; color: black;">View</a></td>
										<td> <a
										href="AddAdmin?id=<%=rs.getString(1)%>&emailid=<%=rs.getString(2)%>"
