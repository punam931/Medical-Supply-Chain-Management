...
<%
	...
	{
	out.println("<script>alert('Congratulations....Login Admin Successfull...!')</script>");	
	}
   %>
	<div class="hero_area">
							...
							<div class="row">
								...
								<div class="col-md-8">
									<div class="detail-box">
										<h1>
											Welcome To Admin  <br> <span> Online Medicine </span>
		...
		<td><b>Mobile Number</b></td>
			...
			<%
					  try{
						  int i=1;
						  String query="select * from transporterregistertbl";
