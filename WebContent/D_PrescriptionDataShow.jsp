	...
	<div class="hero_area">
		...
		<section class=" slider_section position-relative">
			...
			<%
					  try{
						  int i=1;
						  String query="select * from tbl_doctor_prescription where Status='0'";
			...
			%>
				...
				<tr>
					...
					<td>
					<a href="QRCodeupload?id=<%=rs.getString(1)%>&emailid=<%=rs.getString(2)%>" style="background: yellow;color: black;">View</a></td>
					<td>
					
					 <a href="distributeorder?id=<%=rs.getString(1)%>&emailid=<%=rs.getString(2)%>" style="background: yellow;color: black;">Accept</a> 
